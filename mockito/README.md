...
This folder contains example code for using JUnit5 with Mockito and Gradle from the [Mockito tutorial](https://www.vogella.com/tutorials/Mockito/article.html).
